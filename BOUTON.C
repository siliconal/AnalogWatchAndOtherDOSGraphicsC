...
extern void far Contenu(uint16_t colonne, uint16_t ligne, uint16_t largeur, uint16_t hauteur, char *texte)
//begin
{
...
extern void far Contour(uint16_t colonne, uint16_t ligne, uint16_t largeur, uint16_t hauteur,
...
extern void far BoutonRepos(uint8_t codebouton)
//var x:byte;
...
extern void far BoutonAppuie(uint8_t codebouton)
//var x:byte;
    //ligne,colonne,largeur,hauteur:word;
    //size:word;
    //img:pointer;
...
extern void far BoutonSelect(uint8_t codebouton)
//var x:byte;
    //ligne,colonne,largeur,hauteur:word;
    //size:word;
    //img:pointer;
...
extern void far BoutonDeSelect(uint8_t codebouton)
//begin
{
...
extern void far AffBouton(uint16_t colonne, uint16_t ligne, uint16_t largeur, uint16_t hauteur,
...
extern void far Aff2Bouton(uint16_t colonne, uint16_t ligne, uint16_t largeur, uint16_t hauteur,
	      char *textcontenu, uint8_t codebouton)
//begin
{
