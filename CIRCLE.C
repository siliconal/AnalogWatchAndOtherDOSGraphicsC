...
main()      
{
	...
	//begin
	{
		...
		tabnum[numero][0]=arcinfo1.xend;
			//tabnum[numero,2]:=yend;
		tabnum[numero][1]=arcinfo1.yend;
		//end;
		...
		//begin
			//tabpt[numero,1]:=xend;
		tabpt[numero][0]=arcinfo1.xend;
			//tabpt[numero,2]:=yend;
		tabpt[numero][1]=arcinfo1.yend;
		//end;
		//angle:=angle+30;
		angle=angle+30;
		//inc(numero);
	...
	//begin
	{
		...
		//begin
			//tabsec[x1,1]:=xend;
		tabsec[x1][0]=arcinfo1.xend;
			//tabsec[x1,2]:=yend;
		tabsec[x1][1]=arcinfo1.yend;
		//end;
		...
		//begin
			//tabsec1[x1,1]:=xend;
		tabsec1[x1][0]=arcinfo1.xend;
			//tabsec1[x1,2]:=yend;
		tabsec1[x1][1]=arcinfo1.yend;
		//end;
		...
		//begin
			//tabmin[x1,1]:=xend;
		tabmin[x1][0]=arcinfo1.xend;
			//tabmin[x1,2]:=yend;
		tabmin[x1][1]=arcinfo1.yend;
		//end;
		...
		//begin
			//tabmin1[x1,1]:=xend;
		tabmin1[x1][0]=arcinfo1.xend;
			//tabmin1[x1,2]:=yend;
		tabmin1[x1][1]=arcinfo1.yend;
		//end;
		...
		//begin
			//tabmin2[x1,1]:=xend;
		tabmin2[x1][0]=arcinfo1.xend;
			//tabmin2[x1,2]:=yend;
		tabmin2[x1][1]=arcinfo1.yend;
		//end;
		...
		//begin
			//tabhr[x1,1]:=xend;
		tabhr[x1][0]=arcinfo1.xend;
			//tabhr[x1,2]:=yend;
		tabhr[x1][1]=arcinfo1.yend;
		//end;
		...
		//begin
			//tabhr1[x1,1]:=xend;
		tabhr1[x1][0]=arcinfo1.xend;
			//tabhr1[x1,2]:=yend;
		tabhr1[x1][1]=arcinfo1.yend;
		//end;
		//x:=x+6;
		x=x+6;
		//inc(x1);
	...
	//begin
	{
		...
		putimage(347,235,image4,COPY_PUT);
